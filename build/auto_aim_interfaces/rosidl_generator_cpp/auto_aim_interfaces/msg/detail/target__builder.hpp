...
class Init_Target_d_radius
{
public:
  explicit Init_Target_d_radius(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_dz d_radius(::auto_aim_interfaces::msg::Target::_d_radius_type arg)
  {
    msg_.d_radius = std::move(arg);
...
class Init_Target_radius
{
public:
  explicit Init_Target_radius(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_d_radius radius(::auto_aim_interfaces::msg::Target::_radius_type arg)
  {
    msg_.radius = std::move(arg);
    return Init_Target_d_radius(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_radius v_yaw(::auto_aim_interfaces::msg::Target::_v_yaw_type arg)
  {
    msg_.v_yaw = std::move(arg);
    return Init_Target_radius(msg_);
  }
