...
class Target(metaclass=Metaclass_Target):
    ...
    @builtins.property
    def d_radius(self):
        """Message field 'd_radius'."""
        return self._d_radius
    ...
    def d_radius(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'd_radius' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'd_radius' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._d_radius = value
