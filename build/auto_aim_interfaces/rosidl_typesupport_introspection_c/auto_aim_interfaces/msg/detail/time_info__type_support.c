...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__TimeInfo__rosidl_typesupport_introspection_c__TimeInfo_message_member_array[2] = {
  {
    "header",  // name
