...
#define NODE_MAIN_LOGGER_NAME "rm_imu_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librm_imu_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_imu_driver::RM_imu_driver>";
