...
public:
  ...
  : Node("HikCameraNode", options.use_intra_process_comms(true))
  {
    ...
    params_callback_handle_ = this->add_on_set_parameters_callback(
      std::bind(&HikCameraNode::dynamicParametersCallback, this, std::placeholders::_1));
  ...
  void captureLoop()
  {
    ...
    while (rclcpp::ok()) {
      ...
      if (MV_OK == n_ret_) {
        ...
        MV_CC_SetBayerCvtQuality(camera_handle_, 0);
