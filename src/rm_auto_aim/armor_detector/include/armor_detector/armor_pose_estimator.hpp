...
public:
  ...
  std::vector<auto_aim_interfaces::msg::Armor> extractArmorPoses(std::vector<Armor> &armors, Eigen::Matrix3d R_imu_camera);
...
private:
  ...
  Eigen::Matrix3d optimize_yaw(const Armor & armor, const Eigen::Vector3d &t_camera_armor,
                  const Eigen::Matrix3d &R_camera_armor, Eigen::Matrix3d R_imu_camera) const;
