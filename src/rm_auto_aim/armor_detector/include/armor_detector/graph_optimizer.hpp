...
// yaw angle and observation                      //边的误差类型是2维的vector2d 
class EdgeProjection : public g2o::BaseBinaryEdge<2, Eigen::Vector2d, VertexYaw, //二元边类
                                                  g2o::VertexPointXYZ> {    //第一个点是VertexYaw，第二个点是VertexPointXYZ
public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
