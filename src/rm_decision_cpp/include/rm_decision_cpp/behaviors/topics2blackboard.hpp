...
namespace rm_decision
{
  ...
  private:
    ...
    // 全向装甲信息：主相机 + 左/右 USB 相机
    rclcpp::Subscription<auto_aim_interfaces::msg::Armors>::SharedPtr hik_armors_sub_;
    rclcpp::Subscription<auto_aim_interfaces::msg::Armors>::SharedPtr left_armors_sub_;
    rclcpp::Subscription<auto_aim_interfaces::msg::Armors>::SharedPtr right_armors_sub_;
    ...
    // 处理三路相机的装甲识别结果，选择优先级最高的装甲板
    void process_armors_();
    ...
    std::optional<auto_aim_interfaces::msg::Armors> hik_armors_;
    std::optional<auto_aim_interfaces::msg::Armors> left_armors_;
    std::optional<auto_aim_interfaces::msg::Armors> right_armors_;
